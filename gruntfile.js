...
module.exports = function (grunt) {
    ...
    var deployServer = 'u455809.ftp.masterhost.ru',
        deployFolder = 'amhouse.ru',
        liveReloadFolder = 'http://amhouse.ru/';
    ...
    grunt.initConfig({
        ...
        'ftp-deploy': {
            css: {
                ...
                dest: 'amhouse.ru/www/assets/templates/css/',
            ...
            js: {
                ...
                dest: 'amhouse.ru/www/assets/templates/js/',
                exclusions: ['jquery.fancybox.min.js', 'jquery-1.12.0.min.js', 'owl.carousel.min.js', 'ajaxform.js']
            ...
            images: {
                ...
                dest: 'amhouse.ru/wwwassets/templates/img/'
            },
            ...
            'js-minishop': {
                ...
                dest: 'amhouse.ru/wwwassets/components/minishop2/js/web/'
            }
        ...
        watch: {
            ...
            js: {
                ...
                tasks: ['uglify:develop', 'ftp-deploy:js'],
                options: {
                    spawn: false,
                    livereload: {
                        host: liveReloadFolder
