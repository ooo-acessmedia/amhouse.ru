!function(a) {
    ...
    a("#tv-projectcategory_0").on("change", function() {
        ...
        location.href = "http://amhouse.ru/proektyi/?tv|projectcategory=novostroika") : a("#mse2_filters").find(">fieldset").not("#mse2_tv-projectcategory").removeClass("is-vis-hidden");
    ...
    localStorage.setItem("outerPage", "2")), a(".fancybox").fancybox({
        "max-width": "80%",
        "max-height": "80%"
    });
